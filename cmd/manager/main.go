...
import (
	...
	"github.com/appvia/gcp-operator/pkg/apis"
	"github.com/appvia/gcp-operator/pkg/controller"
	"github.com/appvia/gcp-operator/version"
...
func main() {
	...
	err = leader.Become(ctx, "gcp-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
