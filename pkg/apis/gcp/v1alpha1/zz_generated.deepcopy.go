...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GCPAdminToken) DeepCopyInto(out *GCPAdminToken) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GCPAdminToken.
func (in *GCPAdminToken) DeepCopy() *GCPAdminToken {
	if in == nil {
		return nil
	}
	out := new(GCPAdminToken)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *GCPAdminToken) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GCPAdminTokenList) DeepCopyInto(out *GCPAdminTokenList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]GCPAdminToken, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GCPAdminTokenList.
func (in *GCPAdminTokenList) DeepCopy() *GCPAdminTokenList {
	if in == nil {
		return nil
	}
	out := new(GCPAdminTokenList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *GCPAdminTokenList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GCPAdminTokenSpec) DeepCopyInto(out *GCPAdminTokenSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GCPAdminTokenSpec.
func (in *GCPAdminTokenSpec) DeepCopy() *GCPAdminTokenSpec {
	if in == nil {
		return nil
	}
	out := new(GCPAdminTokenSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GCPAdminTokenStatus) DeepCopyInto(out *GCPAdminTokenStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GCPAdminTokenStatus.
func (in *GCPAdminTokenStatus) DeepCopy() *GCPAdminTokenStatus {
	if in == nil {
		return nil
	}
	out := new(GCPAdminTokenStatus)
	in.DeepCopyInto(out)
	return out
}
